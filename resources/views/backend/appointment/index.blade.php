                    ...
                    <div class="panel-body">
                        <div class="table-wrap">
                            <div class="table-responsive">
                                <a href="{{route('appointment.create')}}" class="btn btn-success pull-right">Add new</a>
                                <table id="example" class="table table-hover display pb-30">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$item->doctor->specialist->name}}</td>
                                            <td>{{$item->date}}</td>
                                            <td>{{$item->remarks}}</td>
                                            <td><a href="{{route('changeStatus', $item->id)}}" class="{{$item->status == 'confirmed' ?  'btn btn-sm btn-success': 'btn btn-sm btn-warning'}}">{{$item->status}}</a></td>
                                            <td>
